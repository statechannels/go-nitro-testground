...
// Hardhad accounts and private keys. Widely known to developers, so these are ok to keep in source control
var pks = []string{
...
func NewChainService(seq int64) chainservice.ChainService {
	...
	// todo: is the deployed address guaranteed to be the same?
